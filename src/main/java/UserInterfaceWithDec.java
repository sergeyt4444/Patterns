...
public class UserInterfaceWithDec extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Button buttonFragment = new Button("Fragment");
        buttonFragment.setDisable(true);
        Button buttonReverse = new Button("Reverse");
        buttonReverse.setDisable(true);
        Button buttonMoveToE = new Button("Move to (10, 10)");
        buttonMoveToE.setDisable(true);
        Button buttonMoveToA = new Button("Move to (100, 100)");
        buttonMoveToA.setDisable(true);

        Button buttonLine = new Button("Generate lines");
        buttonLine.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                buttonFragment.setDisable(false);
                buttonReverse.setDisable(false);
                buttonMoveToA.setDisable(false);
                buttonMoveToE.setDisable(false);
                currentCurve = visualLine;
            }
        });
        Button buttonBezier = new Button("Generate Bezier curves");
        ...
        buttonFragment.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                ...
                gN.strokeRect(0, 0, 400, 400);
                gS.strokeRect(0, 0, 400, 400);
                Fragment fragment = new Fragment(currentCurve, 0, 0.5);
                currentCurve = fragment;
                currentCurve.SetDrawer(jfxDrawer1);
                currentCurve.Draw();
                currentCurve.SetDrawer(jfxDrawer2);
                currentCurve.Draw();
                currentCurve.SetDrawer(consoleDrawer);
                currentCurve.Draw();
            }
        });
        ...
        buttonReverse.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                gN.strokeRect(0, 0, 400, 400);
                gS.strokeRect(0, 0, 400, 400);
                Reverse reverse = new Reverse(currentCurve);
        ...
        buttonMoveToE.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                gS.clearRect(0, 0, 400, 400);
                gN.clearRect(0, 0, 400, 400);
                ...
                gN.strokeRect(0, 0, 400, 400);
                gS.strokeRect(0, 0, 400, 400);
                MoveTo moveTo = new MoveTo(currentCurve, e);
                currentCurve = moveTo;
                currentCurve.SetDrawer(jfxDrawer1);
                currentCurve.Draw();
                currentCurve.SetDrawer(jfxDrawer2);
        ...
        buttonMoveToA.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                gS.clearRect(0, 0, 400, 400);
                gN.clearRect(0, 0, 400, 400);
                ...
                gN.strokeRect(0, 0, 400, 400);
                gS.strokeRect(0, 0, 400, 400);
                MoveTo moveTo = new MoveTo(currentCurve, a);
                currentCurve = moveTo;
                currentCurve.SetDrawer(jfxDrawer1);
                currentCurve.Draw();
                currentCurve.SetDrawer(jfxDrawer2);
        ...
        BigBox.getChildren().addAll(hBox, buttonLine, buttonBezier, buttonFragment, buttonReverse,buttonMoveToE, buttonMoveToA);
